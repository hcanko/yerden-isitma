...
st.markdown("Muğla ve çevresi için **Volkan Ticaret Güvencesi** ve **Kalde / Frankische** seçenekleriyle evinize özel tahmini altyapı maliyetini saniyeler içinde görün.")
...
# --- KANCA FİYAT GÜNCELLEMESİ (Kalde bazlı uygun rakamlar) ---
m2_birim_maliyeti_min = 240 
m2_birim_maliyeti_max = 310
...
if st.button("🚀 Bütçemi Hesapla", type="primary", use_container_width=True):
    ...
    # DİKKAT ÇEKİCİ HARİÇTİR VE KALDE UYARISI 
    st.warning("⚠️ **ÖNEMLİ NOT:** Bu başlangıç bütçesi yüksek kaliteli **Kalde PE-RT borular**, TDS Kollektörler ve Karplus 26 Dens Yalıtım malzemeleri (Altyapı sistemi) baz alınarak hesaplanmıştır. Frankische gibi premium marka tercihlerinize göre net fiyat WhatsApp üzerinden verilecektir. **İşçilik ve cihaz fiyatlara HARİÇTİR.**")

    st.markdown("---")
    st.subheader("👇 Net Fiyat ve Ücretsiz Keşif İçin Bize Ulaşın!")
    
    # WHATSAPP BUTONU
    whatsapp_mesaji = f"Merhaba, sitenizden hesaplama yaptım. {alan_taban} m2 taban oturumlu, {kat_secimi} (Toplam {toplam_alan} m2) evim için yerden ısıtma malzeme paketi ile ilgili bilgi almak istiyorum."
    whatsapp_linki = f"https://wa.me/905072784487?text={whatsapp_mesaji}".replace(" ", "%20") 
